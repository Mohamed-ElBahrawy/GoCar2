...
public class SQLiteHandler extends SQLiteOpenHelper {
     ...
     * */
    public void addUser(final String name, final String email, final String age, final String phonenumber, final String nationality, final String uid, final String created_at) {
    ...
    public HashMap<String, String> getUserDetails() {
        ...
        if (cursor.getCount() > 0) {
            ...
            user.put("nationalty",cursor.getString(5));
