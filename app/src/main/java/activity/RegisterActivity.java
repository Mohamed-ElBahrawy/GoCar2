...
public class RegisterActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (!name.isEmpty() && !email.isEmpty() && !password.isEmpty() && !age.isEmpty()&& !phonenumber.isEmpty() && !nationality.isEmpty() )  {
                    registerUser(name, email, password,age, phonenumber, nationality);
                } else {
     ...
     * */
    private void registerUser(final String name, final String email, final String password,final String age,final String phonenumber, final String nationality){
